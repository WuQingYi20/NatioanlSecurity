...
┌─────────────────────────────────────────────────────────────────────────────────────────────────────────┐
│                                                                                                       │
│                                          ◄──── LoRA update (< 1% params, consumer GPU) ◄────┐        │
│                                                                                              │        │
│   ┌──────────────┐      ┌─────────────────────────────────────┐      ┌───────────────┐      │        │
│   │              │      │         AGENT  RL  EPISODE          │      │               │      │        │
│   │  KNOWLEDGE   │      │                                     │      │    HUMAN      │      │        │
...
│   │  ~100M nodes ├─────►│  │ LoRA-A  │ │ LoRA-B  │ │LoRA-N│  │      │  evidence     │      │        │
│   │  ~1B  edges  │ sub- │  └────┬────┘ └────┬────┘ └──┬───┘  │      │  shown first  │      │        │
│   │              │ graph│       │            │         │      │      │               │      │        │
│   │ (read-only)  │      │       └──────┬─────┘─────────┘      │      │  approve /    │      │        │
│   │              │      │              ▼                      │      │  reject       │      │        │
│   └──────────────┘      │     ┌────────────────┐             │      │               │      │        │
...
│                         │     │  clearance()    │          │  │     │    REWARD       │     │        │
│                         │     │  (unlock data,  │          │  │     │                │     │        │
│                         │     │   needs human)  │          │  │     │  R = α·C+β·E   │     │        │
│                         │     │                 │  submit  │  │     │     −γ·P       │     │        │
│                         │     │  submit_        ├──────────┼──┼────►│                │─────┘        │
│                         │     │  evidence()     │          │  │     │  α Confidence  │              │
│                         │     │  (report to     │          │  │     │   ◄─ human     │              │
│                         │     │   human)        │          │  │     │     verdict    │              │
│                         │     └────────────────┘          │  │     │                │              │
│                         │              ▲                   │  │     │  β Efficiency  │              │
│                         │              └───────────────────┘  │     │   ◄─ step      │              │
│                         │          (repeat until submit       │     │     count      │              │
│                         │           or budget = 50 steps)     │     │                │              │
│                         └─────────────────────────────────────┘     │  γ Privacy     │              │
│                                                                     │   ◄─ auto:     │              │
│   GRPO: agents compete on same target                               │     forbidden  │              │
│     agree    → confidence ↑                                         │     access =   │              │
│     disagree → escalate to human                                    │     penalty    │              │
│                                                                     └────────────────┘              │
│                                                                                                      │
│   Design: γ >> α  →  system defaults to UNDER-investigate  →  never harm an innocent person          │
│                                                                                                      │
└─────────────────────────────────────────────────────────────────────────────────────────────────────────┘
```
